    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
      <div class="btn-group">
        ...
        <ul class="dropdown-menu">
          <li v-for="staff in staffs" :key=staff.id @click="isLearner(staff.staff_fname, staff.id)"><a v-if="staff.role_id==2 || staff.role_id==3 || staff.role_id==4" class="dropdown-item" href="#">{{staff.staff_fname}} {{staff.staff_lname}} ({{staff.id}})</a></li>
        </ul>
      </div>
      <div class="btn-group">
