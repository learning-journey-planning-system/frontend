<template>
  <NavBar/>
  <div class="container">
    <a class="nav-link"><router-link style="text-decoration: none; color: inherit;" :to="{name: 'LHomePage'} "><h1 class="goBack"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-arrow-left-circle mb-2" viewBox="0 0 16 16">
